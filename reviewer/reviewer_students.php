...
$query = mysqli_query($conn, "SELECT course_id, school_year_id FROM faculty_course_school_year WHERE user_id = '$user_id'");
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <div class="d-flex justify-content-between align-items-center">
          ...
          <nav>
            <ol class="breadcrumb">
              <li class="breadcrumb-item">
                <a href="reviewer_home.php?user_id=<?php echo $user_id; ?>">Dashboard</a>
              </li>
        ...
        <div>
          <form method="GET" action="reviewer_students.php">
...
if (empty($_GET['school_year']) && $current_school_year) {
  ...
  $sql .= " AND students.school_year_id = '$school_year_id'";
        ...
        <tr>
          ...
          <td><?php echo $sy; ?></td>
          <td class="text-left">
            <a href="reviewer_student_profile.php?user_id=<?php echo $user_id; ?>&stud_id=<?php echo $stud_id; ?>" 
