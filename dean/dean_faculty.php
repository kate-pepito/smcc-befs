            ...
            if ($row = mysqli_fetch_array($result)) {
                ...
                if ($row = mysqli_fetch_array($result)) {
                    ...
                    if (conn()->query($query)) {
                        ...
                        document.location='dean_faculty'</script>";
                    } else {
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Reviewers Accounts</li>
                </ol>
            </nav>
        </div>
                        ...
                        AND users.status = 'Active'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="dean_faculty_update?f_id=<?php echo $id; ?>"><i class="ri-edit-box-fill"></i></a> / <a href="dean_faculty_remove?f_id=<?php echo $id; ?>"><i class="ri-delete-bin-5-fill"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
