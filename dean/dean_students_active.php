...
$school_year = conn()->sanitize($_GET['school_year'] ?? $current_school_year); // Get the selected school year, if any
...
admin_html_head("Active Students", [
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="dean_students_assign_subjects?stud_id=<?= htmlspecialchars($row['stud_id']) ?>&c_id=<?= htmlspecialchars($row['c_id']) ?>">Assign Subjects</a>
                        &nbsp;&nbsp;/&nbsp;&nbsp;
                        <a title="Deactivate Student Account" href="dean_students_remove_sc?stud_id=<?= htmlspecialchars($row['stud_id']) ?>">
