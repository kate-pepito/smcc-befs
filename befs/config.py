...
class Settings:
    REDIS_URL: str = os.getenv("BEFS_REDIS_URL") if os.getenv("BEFS_REDIS_URL") else "redis://localhost:6379/0"
    FASTAPI_SERVER_HOST: str = os.getenv("BEFS_FASTAPI_SERVER_HOST") if os.getenv("BEFS_FASTAPI_SERVER_HOST") else "0.0.0.0"
    FASTAPI_SERVER_PORT: str = os.getenv("BEFS_FASTAPI_SERVER_PORT") if os.getenv("BEFS_FASTAPI_SERVER_PORT") else 5000
