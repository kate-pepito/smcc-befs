...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <div align="right">
        <a href="admin_school_year.php?user_id=<?php echo $user_id; ?>" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSchoolYearModal">Add School Year</a>
      </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php
                  $query = mysqli_query($conn, "SELECT * FROM school_year") or die(mysqli_error());
                  ...
                  <tr>
                    ...
                    ?>
                        <td><div class="col-lg-9 col-md-8"><span class="badge bg-success">Currently Set</span></div></td>
                        <td>Already Set</td>
                    <?php
                    } else {
                    ?>
                        <td><div class="col-lg-9 col-md-8"><span class="badge bg-danger">Not Set</span></div></td>
                        <td><a href="admin_school_year_set_current_sc.php?user_id=<?php echo $user_id; ?>&year_code=<?php echo $id; ?>">Set as Current</a></td>
                    <?php
                    }
                    ?>
                  </tr>
  ...
  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> </button>
        ...
        <div class="modal-body">
          <form action="admin_school_year.php?user_id=<?php echo $user_id; ?>" method="POST">
            <div class="mb-3">
