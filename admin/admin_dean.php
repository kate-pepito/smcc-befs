            ...
            if ($row = mysqli_fetch_array($result)) {
                ...
                if ($row = mysqli_fetch_array($result)) {
                    ...
                    if (mysqli_query($conn, $query)) {
                        ...
                        document.location='admin_dean.php?user_id=$user_id'</script>";
                    } else {
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="admin_dean.php?user_id=<?php echo $user_id; ?>" method="POST" enctype="multipart/form-data" class="row g-3 user needs-validation" novalidate>
                                    <div class="row mb-3">
                        ...
                        AND users.status = 'Active'");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="admin_dean_update.php?user_id=<?php echo $user_id; ?>&f_id=<?php echo $id; ?>"><i class="ri-edit-box-fill"></i></a> / <a href="admin_dean_remove.php?user_id=<?php echo $user_id; ?>&f_id=<?php echo $id; ?>"><i class="ri-delete-bin-5-fill"></i></a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
